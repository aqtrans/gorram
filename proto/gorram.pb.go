...
func (*Config_Deluge) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 0} }
...
func (*Config_LoadAvg) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 1} }
...
func (*Config_DiskSpace) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 2} }
...
func (*Config_ProcessExists) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 3} }
...
func (*Config_GetURL) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 4} }
...
func (*ClientList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*ClientName) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*DebugRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*DebugResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
var fileDescriptor0 = []byte{
	...
	,
}
